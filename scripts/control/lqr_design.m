...
%% 8. SAVE CONTROLLER AND OBSERVER DATA

save(fullfile(SEESAW_ROOT, 'data', 'controller_lqr.mat'), ...
    'K4', 'K5', 'K4d', 'K5d', ...
    'P4', 'P5', 'Ad', 'Bd', 'Cd', 'Dd', ...
    'A5d', 'B5d', 'C5d', 'D5d', ...
    'L', 'Ld', 'Aobs', 'Bobs', 'Cobs', 'Dobs', ...
    'Aobs_d', 'Bobs_d', 'Cobs_d', 'Dobs_d', ...
    'eig_open_4', 'eig_close_4', 'eig_open_5', 'eig_close_5', ...
    'eig_open_4d', 'eig_close_4d', 'eig_open_5d', 'eig_close_5d', ...
    'Q4', 'Q5', 'R4', 'R5', 'Qn', 'Rn', 'Ts');
fprintf('Saved data/controller_lqr.mat\n')
