...
% Simulate CL: x_aug_dot = A_aug_cl * x_aug
[t_out, x_aug_out] = ode45(@(t,x) A_aug_cl*x, t_sim, x_aug0);
u_out = (-K_aug * x_aug_out')';   % control signal [V]
...
sys_cl_dist = ss(A_aug_cl, B_dist_aug, eye(5), zeros(5,1));
