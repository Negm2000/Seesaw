###########################################################################
## Makefile generated for component 'IP02_FreqTest'. 
## 
## Makefile     : IP02_FreqTest.mk
## Generated on : Tue Mar 17 18:45:23 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\IP02_FreqTest.rt-win64
...
COMPILER_COMMAND_FILE     = IP02_FreqTest_comp.rsp
CMD_FILE                  = IP02_FreqTest.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\IP02_FreqTest.rt-win64
...
DEFINES_STANDARD = -DMODEL=IP02_FreqTest -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\IP02_FreqTest_quarc_win64\IP02_FreqTest.c $(START_DIR)\IP02_FreqTest_quarc_win64\IP02_FreqTest_data.c $(START_DIR)\IP02_FreqTest_quarc_win64\IP02_FreqTest_main.c $(START_DIR)\IP02_FreqTest_quarc_win64\rtGetInf.c $(START_DIR)\IP02_FreqTest_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = IP02_FreqTest.obj IP02_FreqTest_data.obj IP02_FreqTest_main.obj rtGetInf.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\IP02_FreqTest_quarc_win64}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\IP02_FreqTest_quarc_win64}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
IP02_FreqTest.obj : "$(START_DIR)\IP02_FreqTest_quarc_win64\IP02_FreqTest.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\IP02_FreqTest_quarc_win64\IP02_FreqTest.c"


IP02_FreqTest_data.obj : "$(START_DIR)\IP02_FreqTest_quarc_win64\IP02_FreqTest_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\IP02_FreqTest_quarc_win64\IP02_FreqTest_data.c"


IP02_FreqTest_main.obj : "$(START_DIR)\IP02_FreqTest_quarc_win64\IP02_FreqTest_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\IP02_FreqTest_quarc_win64\IP02_FreqTest_main.c"


rtGetInf.obj : "$(START_DIR)\IP02_FreqTest_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\IP02_FreqTest_quarc_win64\rtGetInf.c"


rt_nonfinite.obj : "$(START_DIR)\IP02_FreqTest_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\IP02_FreqTest_quarc_win64\rt_nonfinite.c"
